...
CONFIG = {
    "id": "golden-age-canada",
    "date": "2026-06-19",                       # дата публикации/обновления (date-only)
    "h1": "Золотой век Канады",
    "subtitle": "Первые суперзвёзды и Большая шестёрка",
    "chapter_label": "Глава 2 · История хоккея",
    "breadcrumb_name": "Золотой век Канады",
    "og_title": "Золотой век Канады: первые суперзвёзды и Большая шестёрка",
    "og_desc": "Original Six, дерби «Монреаль» — «Торонто», Моренц, «Ракета» Ришар, Горди Хоу и бунт Ришара 1955.",
    "meta_desc": "Золотой век канадского хоккея 1917–1967: Original Six, дерби «Монреаль» — «Торонто», Моренц, «Ракета» Ришар, Горди Хоу и бунт Ришара 1955. Глава 2 истории хоккея.",
    "article_desc": "1917–1967: эпоха Original Six, соперничество «Монреаля» и «Торонто», суперзвёзды Моренц, Ришар и Хоу, бунт Ришара 1955 года.",
    "page_title": "Золотой век Канады · Культура хоккея",
    "section_slugs": ["original-six","montreal-vs-toronto","howie-morenz",
                      "rocket-richard","richard-riot-1955","gordie-howe"],
    "prev": ("origins.html", "← Истоки: от поля до коробки"),
    "next_label": "С чистого льда →",          # следующая глава — пока задизейблена
    "typo_fixes": [("Монреального форума", "Монреальского форума")],
}
# ──────────────────────────────────────────────────────────────────────────────────
